...
export const Projects = () => {
  ...
  const fetchRepos = useCallback(async () => {
    ...
    setError(null);
    try {
      // Dev: call GitHub directly (no proxy needed, fine for local use)
      // Prod (Vercel): call our serverless proxy which uses a secure token
      //                and gets 5,000 req/hr instead of 60
      ...
      // GitHub returns a raw array; our /api/repos proxy returns { repos: [...] }
